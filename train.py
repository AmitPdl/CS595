...
parser.add_argument('--resume_file',default='/scratch/apaudya/Summer/RAGNet/RAGNet-master_OLD/ChPt/CheckPoint_P_24.340.pth',help="resume file path")
parser.add_argument('--lr',default=1e-4,type=float,help="learning rate")
parser.add_argument('--load_workers',default=1,type=int,help="number of workers to load data")      
...
parser.add_argument('--size',type=int,default=16,help="dataset size")
